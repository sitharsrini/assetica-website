      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #f9fafb; padding: 20px;">
          <div style="background: #012241; padding: 24px 32px; border-radius: 12px 12px 0 0;">
            <img src="https://assetica.vercel.app/logo.png" alt="Assetica" style="height: 36px;" />
            <h1 style="color: white; margin: 12px 0 0; font-size: 20px;">New Website Enquiry</h1>
          </div>
          <div style="background: white; padding: 32px; border-radius: 0 0 12px 12px; border: 1px solid #e5e7eb;">
            ...
            <p style="margin-top: 24px; font-size: 12px; color: #9ca3af; text-align: center;">
              Sent from assetica.net contact form · <a href="https://assetica.vercel.app" style="color: #0E9F9F;">Visit site</a>
            </p>
          </div>
        </div>
      `,
